...
print("ZADANIE 15")
send_get("Get all indexes", '/indexes')
send_put("Create new index <ppp>", '/index/ppp')
send_put("Create new index <zzz>", '/index/zzz')
send_get("Get all indexes", '/indexes')
send_delete("Delete <ppp>", '/index/ppp')
send_get("Get all indexes", '/indexes')
send_post('Reindex <users> into <xxx>', '/reindex', {"src": "users", "dest": "xxx"})
send_get('Document for user with ID = 75', '/user/document/75?index=xxx')
